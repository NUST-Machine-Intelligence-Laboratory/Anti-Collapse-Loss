...
class Metric():
    ...
    def __init__(self, embed_dim, mode,  **kwargs):
        ...
        self.requires = ['embeds','avg_features']
    ...
    def __call__(self, embeds=None, avg_features=None):
        ...
        if isinstance(embeds, torch.Tensor):
            ...
            svd = TruncatedSVD(n_components=np.clip(np.clip(self.embed_dim - 1, None, embeds.shape[-1] - 1), None,511),n_iter=7, random_state=42)
            svd.fit(embeds)
